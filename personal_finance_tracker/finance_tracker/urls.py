...
urlpatterns = [
    ...
    path('sources/<str:month_name>/<str:year>/', views.sources, name='sources'),
    path('sources/<str:month_name>/', views.sources, name='sources'),
    path('sources/', views.sources, name='sources'),
    path('spendings/<str:month_name>/<str:year>/', views.spendings, name='spendings'),
    ...
    path('income/<str:month_name>/<str:year>/', views.income, name='income'),
    path('income/<str:month_name>/', views.income, name='income'),
    path('income/', views.income, name='income'),
    path('expenses/<str:month_name>/<str:year>/', views.expenses, name='expenses'),
    path('expenses/<str:month_name>/', views.expenses, name='expenses'),
    path('expenses/', views.expenses, name='expenses'),
    path('<str:month_name>/<str:year>/', views.index, name='index'),
